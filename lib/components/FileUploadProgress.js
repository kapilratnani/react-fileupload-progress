...
var FileUploadProgress = function (_React$Component) {
  ...
  _createClass(FileUploadProgress, [{
    ...
    key: 'onFileSelection',
    value: function onFileSelection(e) {
    ...
    value: function render() {
      var formElement = this.props.formRenderer(this.onSubmit.bind(this), this.onFileSelection.bind(this));
    ...
    value: function _doUpload() {
      ...
      this.props.beforeSend(req).send(this.props.formCustomizer(data));
    }
  }]);
...
FileUploadProgress.propTypes = {
  ...
  binary: _react2.default.PropTypes.boolean,
  ...
  onFileSelection: _react2.default.PropTypes.func
};

FileUploadProgress.defaultProps = {
  formRenderer: function formRenderer(onSubmit, onFileSelection) {
    return _react2.default.createElement(
      'form',
      ...
      _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { type: 'file', value: undefined.state.selectedFile, name: 'file', onChange: onFileSelection })
      ),
      _react2.default.createElement('input', { type: 'submit', disabled: undefined.props.disabled })
    );
  },
  ...
  onFileSelection: function onFileSelection(selectedFile) {},
  binary: false,
  disabled: false
};
